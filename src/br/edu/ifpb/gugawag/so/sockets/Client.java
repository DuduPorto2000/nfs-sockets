...
public class Client {
    ...
    public static void main(String[] args) throws IOException {
        ...
        do {
            System.out.println("==============================================");
            System.out.println("Digite uma das opcoes abaixo:('Q' para sair)");
            System.out.println("readdir | rename | create | remove");
            System.out.println("==============================================");
            ...
            if (mensagem.trim().toUpperCase(Locale.ROOT).equals("Q")) {
                break;
            }
            if (mensagemLida != null) {
                if (mensagem.trim().toLowerCase(Locale.ROOT).matches("rename")) {
                    System.out.println(mensagemLida);
                    System.out.println("Digite o número do arquivo a ser renomeado ou aperte 'Q' para sair: ");
                    ...
                    if (numeroArquivo != null && !numeroArquivo.trim().equals("") && mensagemLidaNumeroArquivo.equals("")) {
                        ...
                        if (!numeroArquivo.trim().toUpperCase(Locale.ROOT).equals("Q") &&
                    ...
                    System.out.println(mensagemLida);
                    System.out.println("Digite o número do arquivo a ser removido ou aperte 'Q' para sair: ");
                    Scanner nomeArquivo = new Scanner(System.in);
                    String numeroArquivo = nomeArquivo.nextLine();
                    dos.writeUTF(numeroArquivo);
                    String mensagemLidaNumeroArquivo = dis.readUTF();
