    ...
    public static void main(String[] args) throws IOException {
        ...
        do {
            ...
            if (mensagem != null && !mensagem.trim().equals("")) {
                home = new File(HOME);
                listFiles = listFilesOfFolderRename(home);
                switch (mensagem.trim().toLowerCase(Locale.ROOT)) {
                    ...
                    case "rename" -> {
                        ...
                        if (indexFileChange != null && !indexFileChange.trim().equals("")) {
                            ...
                            if (!indexFileChange.toUpperCase(Locale.ROOT).equals("Q") &&
                                ...
                                if (!arquivoNovo.exists()) {
                                    ...
                                    resposta = "Nome do Arquivo alterado!";
                                } else
                                    resposta = "O novo nome escolhido já existe!";
                            } else {
                    ...
                    case "create" -> {
                        ...
                        if (!arquivoNovo.exists()) {
                            ...
                            resposta = "Aquivo com esse nome já existe!";
                        break;
                    }
                    default -> resposta = "Comando Invalido";
                }
    ...
    public static String listFilesOfFolder(final File folder) {
        ...
        for (final File fileEntry : folder.listFiles()) {
            if (fileEntry.isDirectory())
                resposta.append("<DIR> ").append(fileEntry).append("\n");
            else
                resposta.append("      ").append(fileEntry.getName()).append("\n");
        }
